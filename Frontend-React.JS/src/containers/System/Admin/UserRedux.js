...
class UserRedux extends Component {
    ...
    handlOnchangeImage = (event) => {
        let data = event.target.files;
        let file = data[0]
        if (file) {
            let objctUrl = URL.createObjectURL(file);
            this.setState({
                previewImgURL: objctUrl
            })
        }
    }
    openPreviewImage = () => {
                        ...
                        <div className='row'>
                            ...
                            <div className='col-3'>
                                ...
                                <div className='preview-img-container'>
                                    <input id='previewImg' type='file' hidden onChange={(event) => this.handlOnchangeImage(event)} />
